...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(
        ...
        mri_dir_val='/blue/kgong/gongyuxin/taupet/ADNI_data/MRI5',
        ...
        output_dir="/blue/kgong/gongyuxin/taupet/BrLP/scripts/unet_output2",  # Path to the output directory
        aekl_ckpt="/blue/kgong/gongyuxin/taupet/BrLP/scripts/ae_output_autoencoder/autoencoder-ep-600.pth",
