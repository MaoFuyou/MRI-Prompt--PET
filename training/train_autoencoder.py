...
if __name__ == '__main__':
    args = argparse.Namespace(
        dataset_csv="/orange/kgong/Data/ADNI/data_PET2.csv",
        cache_dir="/blue/kgong/gongyuxin/taupet/BrLP/scripts/ae_cache",
        output_dir="/blue/kgong/gongyuxin/taupet/BrLP/scripts/ae_output",
        aekl_ckpt=None,
        disc_ckpt=None,
        num_workers=8,
        n_epochs=5,
    ...
    split_ratio = 2/3
    train_size = int(len(dataset_df) * split_ratio)
    dataset_df['split'] = ['train'] * train_size + ['test'] * (len(dataset_df) - train_size)
    train_df = dataset_df[dataset_df['split'] == 'train']
