...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(
        image_dir="/blue/kgong/gongyuxin/taupet/ADNI_data/MRI5",  # Path to the image folder
        output_dir="/blue/kgong/gongyuxin/taupet/BrLP/scripts/ae_output_mri",
        aekl_ckpt=None,
        disc_ckpt=None,
        num_workers=8,
        n_epochs=1000,
    ...
    # Data loading
    trainset = MRIDataset(image_dir=args.image_dir)
